...
# Form implementation generated from reading ui file 'tesqt5designer.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton1.setGeometry(QtCore.QRect(370, 390, 75, 23))
        self.pushButton1.setObjectName("pushButton1")
        self.pushButton2 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton2.setGeometry(QtCore.QRect(460, 390, 75, 23))
        self.pushButton2.setObjectName("pushButton2")
        self.label1 = QtWidgets.QLabel(self.centralwidget)
        self.label1.setGeometry(QtCore.QRect(370, 430, 181, 41))
        self.label1.setObjectName("label1")
        self.hslider1 = QtWidgets.QSlider(self.centralwidget)
        self.hslider1.setGeometry(QtCore.QRect(50, 400, 160, 22))
        self.hslider1.setMinimum(-90)
        self.hslider1.setMaximum(90)
        self.hslider1.setSingleStep(0)
        ...
        self.hslider2.setGeometry(QtCore.QRect(50, 430, 160, 22))
        ...
        self.hslider3.setGeometry(QtCore.QRect(50, 460, 160, 22))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_graph.setText(_translate("MainWindow", "Random Graph"))
